...
Start command: uvicorn api.main:app --host 127.0.0.1 --port 18081 --reload
...
async def check_environment():
    ...
    try:
        # Prefer the current interpreter so vendorized deployments do not depend on an external uv binary.
...
if __name__ == "__main__":
    ...
    port = int(os.getenv("MEDIACRAWLER_API_PORT", "18081"))
