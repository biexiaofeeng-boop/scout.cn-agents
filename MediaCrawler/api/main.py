...
from .security import docs_enabled, require_api_key, trusted_hosts
...
# Register routers
app.include_router(crawler_router, prefix="/api", dependencies=[Depends(require_api_key)])
app.include_router(data_router, prefix="/api", dependencies=[Depends(require_api_key)])
...
async def serve_frontend():
    ...
    docs_path = "/docs" if docs_enabled() else "disabled"
    return {
...
@app.get("/api/env/check", dependencies=[Depends(require_api_key)])
